...
@ResponsePayload
public AddEmployeeResponse addEmployee (@RequestPayload AddEmployeeRequest
request) {
...
@ResponsePayload
public GetEmployeeResponse getEmployee (@RequestPayload GetEmployeeByIdRequest
request) {
...
@ResponsePayload
public UpdateEmployeeResponse updateEmployee (@RequestPayload
...
@ResponsePayload
public DeleteEmployeeResponse deleteEmployee (@RequestPayload
